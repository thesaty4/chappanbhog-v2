...
import BiryaniImg1 from "../../assets/food3.png";
import BiryaniImg2 from "../../assets/food2.png";
            ...
            >
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold">
                ...
                <span
                  ...
                  style={{
                    color: "#ff9c01 var(--tw-gradient-to-position)",
              ...
              <p className="text-sm ">
                Savor tasty, fresh meals at budget-friendly prices, starting
                from just ₹100. Quality and affordability in every bite.
              </p>
              <div>
                <button
