            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                Immerse yourself in our modern yet comfortable ambiance, perfect for intimate dinners and lively gatherings. 
                  <br />
                  <br />
                  Relish diverse seating options tailored to your preference. Our commitment to cleanliness ensures a safe dining experience. Indulge in signature dishes, meticulously prepared with the freshest ingredients, starting at just ₹100. At Chhappanbhog, we promise not just a meal but a symphony of flavors, quality, and a memorable dining affair. Join us for an unparalleled culinary experience that defines the true art of dining.
                </p>
